      ...
      <section className="section">
        <div className="section-inner narrow legal-body">
          ...
          <p>
            ...
            LLC が提供する「Googleアナリティクス」を利用しています。Googleアナリティクスはトラフィックデータの収集のためにCookieを使用しますが、このデータは個人を特定しない形で収集されており、特定の個人を識別するものではありません。ブラウザの設定でCookieを無効にすることで、収集を拒否することも可能です。
          </p>
          <p>
            データの取り扱いについては
            <a
          ...
          <p className="legal-updated">制定日: 2026年6月1日</p>
        </div>
      </section>
    </>
  )
